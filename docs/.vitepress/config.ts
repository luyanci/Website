...
export default defineConfig({
          ...
          changefreq:
            item.url === '/'
              ...
              : item.url.includes('/guide/')
                ...
                : 'monthly',
          priority:
            item.url === '/' ? 1.0 : item.url.includes('/guide/') ? 0.9 : 0.7,
        }))
    },
  },
  ...
  head: [
    ...
    [
      'link',
      { rel: 'mask-icon', href: '/safari-pinned-tab.svg', color: '#64edff' },
    ],
    [
      'meta',
      {
    ...
    [
      'meta',
      { property: 'og:image', content: 'https://sukisu.org/og-image.png' },
    ],
    ...
    [
      'meta',
      { property: 'twitter:image', content: 'https://sukisu.org/og-image.png' },
    ],
